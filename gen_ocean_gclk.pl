...
###################################################################
$gclk2q = 0.325;	## ns from gclk posedge to stimulus
$rise_fall = 0.05;	## rise fall time of signals in ns
$PW = 0.375;		## pulse width for pulse latches
$basefile = $ARGV[0];
...
printf OUTFILE "vgclk gclk 0 pulse 0 1.8 %1.2fns %1.2fns %1.2fns %1.2fns %1.2fns\n",$half_period,$rise_fall,$rise_fall,$PW,$period;
...
printf OCN "id=ipcBeginProcess(\"~ejhoffman\/perl_progs\/check_res_pls.pl %s\")\n",$basefile;
printf OCN "ipcWaitForChild(id)\n";
